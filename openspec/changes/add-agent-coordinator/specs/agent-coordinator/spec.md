...
## Purpose
Orchestrates multi-agent system by classifying user intent and routing requests to specialized agents (Search Team, Auditor, Comparator, etc.). Acts as the central decision-maker in the conversational agent architecture.
