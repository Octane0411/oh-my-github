...
## Purpose
Defines the Server-Sent Events (SSE) protocol for real-time streaming of agent operations. Provides users with transparent progress updates, incremental text, and structured data during long-running operations.
