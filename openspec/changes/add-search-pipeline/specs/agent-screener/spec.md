...
## Purpose
Filters and ranks Scout's 50-100 candidate repositories down to Top 10 using a two-stage approach: rule-based coarse filtering (Stage 1) followed by LLM-powered fine scoring with multi-dimensional evaluation (Stage 2).
