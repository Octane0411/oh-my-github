...
## Purpose
Implements the LangGraph.js state machine for orchestrating the Sequential Pipeline (Query Translator → Scout → Screener). Manages global state, node execution, error handling, and provides foundation for future streaming capabilities.
