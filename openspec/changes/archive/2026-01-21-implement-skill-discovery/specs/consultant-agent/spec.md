...
## Purpose
The Consultant Agent is a conversational supervisor that manages multi-turn dialogue with users, classifies their intent, and orchestrates specialized pipeline tools (Discovery, Fabrication) to help users find and convert GitHub repositories into Agent Skills.
